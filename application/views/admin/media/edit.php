              ...
              <div class="row">
                <div class="col-md-12">
                  <div class="form-group">
                    <label>Tanggal</label>
                    <input type="hidden" value="<?php echo $media['id']?>" name="id">
                    <input type="date" name="tanggal" class="form-control" value="<?= (isset($media))?$media['tanggal']:''?>"  placeholder="Company" required>
                  </div>
                </div>
              </div>
              <hr>
                <div class="row">
                  <div class="col-md-12">
                    <div class="form-group">
                      ...
                      <input type="text" name="nama" class="form-control"  placeholder="Isi nama file" maxlength="15" value="<?= (isset($media))?$media['nama']:''?>" required>
                    </div>
                  </div>
                </div>
                <div class="row">
                  ...
                  <div class="input-group mb-3">
                    ...
                    <input type="hidden" value="<?php echo $media['file']?>" name="file_lama">
                    <input type="file" name="file" class="form-control" placeholder="Your Email" accept="application/pdf, application/vnd.ms-excel, application/msword" >
